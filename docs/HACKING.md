...
| **`synapse-engine`** | `crates/synapse-engine` | Multi-torrent `SwarmEngine`: Hot/Warm/Cold swarm virtualization, Endgame mode, token-bucket rate limits, QueueManager, NAT-PMP/UPnP, and Conduit lifecycle hooks. |
